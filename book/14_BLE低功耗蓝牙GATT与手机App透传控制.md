...
至此，你已经完整掌握了 ESP32 的两大无线通信王牌：**广域互联网（Wi-Fi + MQTT）** 与 **近场局域网（BLE 蓝牙）**！

在接下来的阶段六中，我们将向**大容量外部存储、极致电池休眠与工业级系统架构**进军！

请翻开 [**第 15 章：ESP32 挂载 MicroSD/TF 卡(4-bit SDIO)与 FATFS 电子相册**](./15_TF卡文件系统与电子相册.md)！

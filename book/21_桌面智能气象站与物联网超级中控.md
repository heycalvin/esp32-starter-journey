...
│   └── app_main.c                      # 纯流水线总装入口
│
├── 📁 server/                          # 💻 2. PC 端 Web 智能管理平台 (Rust + Vue 3)
...
1. 使用 Android Studio 打开 `code/21_final_station_hub/app/android_native/`；
...
1. 用手机 Chrome 或 Edge 浏览器打开 `code/21_final_station_hub/app/web_bluetooth/index.html`；
